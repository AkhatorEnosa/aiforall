...
const Hero = () => {
  return (
    <div className='w-full flex flex-col gap-8 justify-center items-center px-64 pt-20 text-center'>
        <div className='w-96 h-96 p-12 bg-[#FFDE59] z-10 absolute top-5 blur-3xl opacity-15'>
        </div>
        <div className='flex gap-4 bg-white/10 backdrop-blur-sm pr-4 rounded-full justify-center items-center'><span className='flex gap-1 bg-[#FBCE07] px-4 py-2 rounded-full z-50'>New <Image src="/assets/star.png" width={7.78} height={7.78} alt='star'/></span>Use AI Assistant for better learning</div>
